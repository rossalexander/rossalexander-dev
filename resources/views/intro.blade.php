<div class="w-full h-screen flex items-center bg-slate-900">
    <div id="intro" class="hidden max-w-[1200px] mx-auto p-4 sm:p-8 w-full">
        ...
        <span class="text-2xl sm:text-5xl text-slate-400 tracking-tight sm:leading-snug">specializing
            in <span class="text-rose-500">test-driven development</span>
            with <span
                class="text-rose-500 font-bold">PHP</span>,
            <span class="text-rose-500 font-bold">Laravel</span> and <span
                class="text-rose-500 font-bold">Vue</span>.</span>
        </p>
    </div>
</div>
